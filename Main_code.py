...
month = Label(root, text=dt.strftime('-%m-'),
              bg='light green', font=("bold", 15))
...
llon = Label(root, text="Longitude :", width=0,
             bg='light green', font=("Helvetica", 15))
llon.place(x=30, y=100)
lable_lon = Label(root, text="....", width=0,
                  bg='light green', font=("Helvetica", 15))
lable_lon.place(x=155, y=100)

llat = Label(root, text="Latitude :", width=0,
             bg='light green', font=("Helvetica", 15))
...
lable_temp = Label(root, text="...", width=0, bg='light green',
